...
<div class="container pl-4">
    <div class="row">
        ...
        <div class="col-sm-9">
            <h2 class="text-center">Безопасность</h2>
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="exampleInputVeh1">Марка вашего автомобиля</label>
                        <input type="text" class="form-control form_edit_profile_field" id="exampleInputVeh1" aria-describedby="vehHelp" placeholder="...">
                        <small id="vehHelp" class="form-text text-muted">Свободное текстовое поле</small>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="exampleInputVeh2">Модель вашего автомобиля</label>
                        <input type="text" class="form-control form_edit_profile_field" id="exampleInputVeh2" aria-describedby="vehHelp" placeholder="...">
                        <small id="vehHelp" class="form-text text-muted">Свобоодное текстовое поле</small>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="exampleInputEmail">Биография вашего автомобиля</label>
                        <input type="text" class="form-control form_edit_profile_field" id="exampleInputVehDesc" aria-describedby="vehHelp" placeholder="...">
                        <small id="emailHelp" class="form-text text-muted">Небольшой рассказ о вашем автомобиле</small>
                    </div>
                </div>
                <div class="col-sm-12">
