            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="exampleInputEmail">Ваш текущий Email</label>
                        ...
                        <small id="emailHelp" class="form-text text-muted">При обновлении Email требует ввода пароля в поле "Старый пароль"</small>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="exampleInputEmail">Старый пароль</label>
                        <input type="email" class="form-control form_edit_profile_field" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ваш адрес электронной почты, если его надо сменить..." value="example@gb.ru">
                        <small id="emailHelp" class="form-text text-muted">Требуется при смене Email или пароля</small>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="exampleInputEmail">Новый пароль</label>
                        <input type="email" class="form-control form_edit_profile_field" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ваш адрес электронной почты, если его надо сменить..." value="example@gb.ru">
                        <small id="emailHelp" class="form-text text-muted">Требует заполнения старого пароля</small>
                    </div>
                </div>
                <div class="col-sm-12">
