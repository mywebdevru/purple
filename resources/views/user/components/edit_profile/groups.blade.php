    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <div class="currentclub py-4 px-4 mb-2">
                <h4 class="mb-2">Ваши группы <a data-toggle="collapse" href="#clubslistcollapse" role="button" aria-expanded="false" aria-controls="clubslistcollapse"><i class="fas fa-arrow-down"></i></a></h4>
                <div class="collapse clubslistcollapse" id="clubslistcollapse">
                    ...
                    <div class="text-center mb-2">
                        ...
                        <h3 class="text-center">Что-то?</h3>
            ...
            <div class="clubstosub py-4 px-4">
                <h4 class="mb-2">Группы, на которые можно подписаться <a data-toggle="collapse" href="#clubstosubcollapse" role="button" aria-expanded="false" aria-controls="clubstosubcollapse"><i class="fas fa-arrow-down"></i></a></h4>
                <div class="collapse clubstosubcollapse" id="clubstosubcollapse">
                    <div class="clubstosub_block py-4 px-4">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <h3 class="mb-2">Тестовая группа?</h3>
                                <l>Москва</l>
                                <div class="flex-center mt-2">
                                    <button class="btn btn-primary">Страница группы</button>
                    ...
                    <div class="clubstosub_block py-4 px-4">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="flex-center mt-2">
                                    <button class="btn btn-primary">Страница группы</button>
                                    <button class="btn btn-success">Подписка оформлена</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="clubstosub_block py-4 px-4">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="flex-center mt-2">
                                    <button class="btn btn-primary">Страница группы</button>
                                    <button class="btn btn-danger">Подписка отменена</button>
                                </div>
                            </div>
                        </div>
                    </div>
