<div class="container">
    <div class="col-md-12" wire:ignore>
        ...
        <div class="ui-block w-75 mx-auto">
            <input wire:model.defer="title" id="map_title" type="text" name="name" placeholder="Название карты" class="map-title">
    ...
    <div class="text-center">
        ...
        <button type="button" class="btn btn-file btn-md-2 btn-success comment-form__button" wire:click.prevent="saveDraft" wire:loading.attr="disabled">Сохранить Черновик</button>
    ...
    <script>
        ...
        ymaps.ready(init);
        function init() {
            let coord, obj, currentId, object, btnLayout, btnOptions, placemarkBtn, lineBtn, MyBalloonContentLayout, polygonBtn, myPlacemark, myPolyline, myPolygon, element, geoObj
